...
alldata['5']=dict(nomor=5, nama="cristiano ronaldo", posisi="penyerang")
alldata['6']=dict(nomor=6, nama="marcus rashford", posisi="penyerang")
alldata['7']=dict(nomor=7, nama="Bruno Fernandes", posisi="gelandang")
alldata['8']=dict(nomor=8, nama="Edinson Cavani", posisi="penyerang")
alldata['9']=dict(nomor=9, nama="Anthony Elanga", posisi="bek tengah")
alldata['10']=dict(nomor=10, nama="Jadon Sancho", posisi="penyerang")
alldata['11']=dict(nomor=11, nama="Lee Grant", posisi="kiper")
alldata['12']=dict(nomor=12, nama="Tom Heaton", posisi="kiper")
alldata['13']=dict(nomor=13, nama="Dean Henderson", posisi="kiper")
alldata['14']=dict(nomor=14, nama="Eric Bailly", posisi="bek kanan")
alldata['15']=dict(nomor=15, nama="Phil Jones", posisi="bek tengah")
alldata['16']=dict(nomor=16, nama="Harry Maguire", posisi="bek tengah")
alldata['17']=dict(nomor=17, nama="Raphael Varane", posisi="bek tengah")
alldata['18']=dict(nomor=18, nama="Diogo Dalot", posisi="gelandang")
alldata['19']=dict(nomor=19, nama="Paul Pogba", posisi="gelandang")
alldata['20']=dict(nomor=20, nama="	Juan Mata", posisi="gelandang")
